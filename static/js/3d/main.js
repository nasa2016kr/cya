;function Asterank3D(opts) {
  ...
  opts.object_texture_path = "http://www.asterank.com/static/img/cloud4.png";
 ...
 //}
  ...
  function init(){
    ...
    var texture = loadTexture('http://www.asterank.com/static/img/sunsprite.png');
    ...
    var mercury = new Orbit3D(Ephemeris.mercury,
        {
          ...
          texture_path: 'http://www.asterank.com/static/img/texture-mercury.jpg',
    ...
    var venus = new Orbit3D(Ephemeris.venus,
        {
          ...
          texture_path: 'http://www.asterank.com/static/img/texture-venus.jpg',
    ...
    var earth = new Orbit3D(Ephemeris.earth,
        {
          ...
          texture_path: 'http://www.asterank.com/static/img/texture-earth.jpg',
    ...
    var mars = new Orbit3D(Ephemeris.mars,
        {
          ...
          texture_path: 'http://www.asterank.com/static/img/texture-mars.jpg',
    ...
    var jupiter = new Orbit3D(Ephemeris.jupiter,
        {
          ...
          texture_path: 'http://www.asterank.com/static/img/texture-jupiter.jpg',
    ...
    var uniforms = {
      texture: { type: 't', value: loadTexture('http://www.asterank.com/static/img/eso_dark.jpg') }
    };
  ...
  function setUserObject(asteroid) {
    if (locked_object) {
      clearLock();
    }

    locked_object = asteroid;
    locked_object_idx = mapped_obj['idx']; // this is the object's position in the added_objects array
    locked_object_color = attributes.value_color.value[locked_object_idx];
    attributes.value_color.value[locked_object_idx] = new THREE.Color(0x0000ff);
    locked_object_size = attributes.size.value[locked_object_idx];
    attributes.size.value[locked_object_idx] = 30.0;
    attributes.locked.value[locked_object_idx] = 1.0;
    setAttributeNeedsUpdateFlags();
  ...
  function createParticleSystem() {
    ...
    uniforms = {
      ...
      planet_texture:
        { type: 't', value: loadTexture('http://www.asterank.com/static/img/cloud4.png') },
      small_roid_texture:
        { type: 't', value: loadTexture(opts.object_texture_path) },
      small_roid_circled_texture:
        { type: 't', value: loadTexture('http://www.asterank.com/static/img/cloud4-circled.png') }
    };
